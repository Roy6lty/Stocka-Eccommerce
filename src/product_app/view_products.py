from ..extentions import  redis_connector, client
from flask import render_template, redirect, url_for, flash, request, Blueprint
from ..utils import save_picture
from ..forms import Add_product, Comments
from flask_login import   current_user
from ..cart import  CartId, AddItem, DeleteItem
...
@CartId
def shopping_page():
    items = StockaProducts.find() #returns mongodb generator
...
app_product.route('/search/<items>', methods=['GET', "POST"])
def Search_Return():
    form= Add_product()
